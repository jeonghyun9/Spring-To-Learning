...
<body>
<c:set var="to"   value="10" /> <!-- 디폴트 값으로 스코프 맵에 저장됨. (key=to, value=10) -->
...
=============================================================<br>
	<c:forEach var="elem" items="${arr}" varStatus="status">
		${status.index}. arr[${status.index}]=${elem}<BR>
	</c:forEach>
</c:if>	
<br>
=============================================================<br>
<c:if test="${param.msg != null}">
	msg=${param.msg} 
	msg=<c:out value="${param.msg}"/> <!-- c:out : url에 있는 값을 그대로 반영한다. 태그해석 X -->
</c:if>
<br>
=============================================================<br>
<br>
